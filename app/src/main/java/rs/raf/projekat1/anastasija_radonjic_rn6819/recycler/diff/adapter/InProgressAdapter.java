...
public class InProgressAdapter extends ListAdapter<Ticket, InProgressAdapter.ViewHolder> {
    ...
    public final Consumer<Ticket> onMoveRightTicket;
    public final Consumer<Ticket> onMoveLeftTicket;

    public InProgressAdapter(@NonNull DiffUtil.ItemCallback<Ticket> diffCallback, Consumer<Ticket> onEnhancmentClicked,
                             Consumer<Ticket> onMoveRightTicket,
                             Consumer<Ticket> onMoveLeftTicket) {
            super(diffCallback);
            this.onEnhancmentClicked = onEnhancmentClicked;
            this.onMoveRightTicket = onMoveRightTicket;
            this.onMoveLeftTicket = onMoveLeftTicket;
            }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            Ticket ticket = getItem(position);
            onMoveRightTicket.accept(ticket);
            }, position ->{
            Ticket ticket = getItem(position);
            onMoveLeftTicket.accept(ticket);
            });
            }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView, Context context,
            ...
            itemView.findViewById(R.id.arrowRightInProgressIv).setOnClickListener(v -> {
                if (getBindingAdapterPosition() != RecyclerView.NO_POSITION)
                    onMoveTicket.accept(getBindingAdapterPosition());
            });

            itemView.findViewById(R.id.arrowLeftInProgressIv).setOnClickListener(v -> {
                if (getBindingAdapterPosition() != RecyclerView.NO_POSITION)
    ...
    //            Timber.e("IsInprogress je:" + isInProgres);
            ((TextView)itemView.findViewById(R.id.titleInProgressTv)).setText(ticket.getTitle());
            ((TextView)itemView.findViewById(R.id.descriptionInProgressTv)).setText(ticket.getDescription());
            ...
            if(((TextView) itemView.findViewById(R.id.titleInProgressTv)).getText().toString().startsWith("En")){
                ticket.setImage(enc);
                ((ImageView)itemView.findViewById(R.id.rocketPictureInProgressIv)).setImageDrawable(enc);
            }
            else if(((TextView) itemView.findViewById(R.id.titleInProgressTv)).getText().toString().startsWith("Bu")){
                ticket.setImage(enc);
                ((ImageView)itemView.findViewById(R.id.rocketPictureInProgressIv)).setImageDrawable(bug);
            }
